...
class JpaComponentFactory(val context: ComponentContext) extends StockImporterComponentImpl with StockDBServiceComponentImpl with SymbolImporterComponentImpl {
